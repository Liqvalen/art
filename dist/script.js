...
var filter = function filter() {
  ...
  function bindButtons(btnSelector, markSelector) {
    btnSelector.addEventListener('click', function () {
      typeFilter(markSelector);
    });
  }
  bindButtons(btnAll, markAll);
  bindButtons(btnLovers, markLovers);
  bindButtons(btnChef, markChef);
  bindButtons(btnGirl, markGirl);
  bindButtons(btnGuy, markGuy);
  bindButtons(btnGrandmother, '');
  bindButtons(btnGranddad, '');
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var animateSelector = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'fadeIn';
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        windows.forEach(function (item) {
          item.style.display = 'none';
          item.classList.add('animated', animateSelector);
        });
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.clientHeight);
  ...
  bindModal('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', 'fadeIn', true);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    (0,_services_requests__WEBPACK_IMPORTED_MODULE_5__.getResource)('assets/db-2.json').then(function (res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Cound not fetch ".concat(url, ", status: ").concat(res.status));
        case 5:
          _context2.next = 7;
          return res.json();
        case 7:
